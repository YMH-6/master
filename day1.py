...
a=(253.6*10+86.3*60+96.8*43+135.9*63+65.8*63+49.3*120+86.3*72/
   ...
   +86.3*60+65.8*129+253.6*10+96.8*43+65.8*63+86.3*60+135.9*63+96.8*60+65.8*58+86.3*140+65.8*48/
   96.8*43+135.9*57+253.6*10+65.8*63+96.8*78)
b=a/30
print("总销售额 ="+str(a))
print(b)
print("每日平均销量 ="+str(b))
print("羽绒服占比",(10+69+140+10+10)/1845 )
print("牛仔裤占比",(60+72+35+90+60+60+140)/1845)
print("风衣占比",(43+25+43+60+43+78)/1845)
print("皮草占比",(63+24+63+57)/1845)
print("T恤占比",(63+45+129+48+78)/1845)
print("衬衫占比",120/1845)
